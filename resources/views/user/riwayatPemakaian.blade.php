    ...
    <div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <div>
            ...
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                Menampilkan riwayat perjalanan kendaraan yang sedang login.
            </p>
        </div>
        ...
        <div class="border-b border-gray-100 px-5 py-4 dark:border-gray-800 sm:px-6">
            <div class="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
                ...
                <div>
                    ...
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                        Riwayat perjalanan yang telah selesai untuk kendaraan {{ $kendaraan->no_polisi ?? '-' }}.
                    </p>
                </div>

                {{-- Form filter --}}
                <form action="{{ route('kendaraan.riwayat-pemakaian') }}" method="GET" class="flex flex-wrap items-center gap-3">
                    ...
                    <div class="relative">
                        <input
                            ...
                            name="search"
                            value="{{ $search ?? '' }}"
                            placeholder="Cari kode tugas, tujuan, catatan..."
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-left">
                ...
                <tbody class="divide-y divide-gray-100 dark:divide-gray-800">
                    @forelse($riwayatPemakaian as $item)
                            ...
                            <td class="px-5 py-4 text-center">
                                @php
                                    $detailData = [
                                        ...
                                        'foto_odometer' => (!empty($item->foto_odometer) && trim($item->foto_odometer) !== '') ? route('penugasan.odometer-foto', $item->id) : null,
