<div class="rounded-[10px] bg-white p-6 shadow-1 dark:bg-gray-dark dark:shadow-card h-full flex flex-col">
    ...
    <div class="mb-5">
        ...
        <p class="text-sm text-gray-500 dark:text-gray-400">
            Distribusi status laporan kerusakan
        </p>
    </div>

    <div class="flex-1 flex items-center justify-center">
        <div id="damageStatusChart" class="w-full"></div>
    </div>
...
document.addEventListener("DOMContentLoaded", function () {
    const el = document.querySelector("#damageStatusChart");
    if (!el) return;
    ...
    function getChartOptions() {
        ...
        return {
            ...
            colors: ['#FB5454', '#3C50E0', '#FFBA00', '#10B981', '#80CAEE'],
            stroke: {
                show: true,
                width: 3,
