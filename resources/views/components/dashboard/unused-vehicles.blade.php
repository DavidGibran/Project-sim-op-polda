    ...
    <div class="p-5 sm:p-6 lg:p-7.5">
        <div class="flex flex-col gap-5">
            @forelse($kendaraanTidakDigunakan as $kendaraan)
                <div class="flex items-center justify-between gap-3 p-4 rounded-xl border border-gray-100 dark:border-gray-800 bg-gray-50/50 dark:bg-white/[0.02]">
                    ...
                    <div class="text-right">
                        @if($kendaraan->tgl_terakhir)
                            ...
                            @endphp
                            <span class="inline-flex rounded-lg bg-warning/10 px-2 py-1 text-xs font-medium text-warning">
                                {{ $days }} Hari Lalu
                            </span>
                            <p class="mt-1 text-[10px] text-gray-400 dark:text-gray-500 whitespace-nowrap">
                                Terakhir dipakai
                            </p>
                        @else
                            <span class="inline-flex rounded-lg bg-error/10 px-2 py-1 text-xs font-medium text-error">
