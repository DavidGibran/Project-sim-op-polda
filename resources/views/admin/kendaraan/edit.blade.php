        ...
        <div class="p-6">
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="kategori_kendaraan" required class="w-full rounded-lg border border-gray-200 bg-white py-2 px-4 text-gray-700 outline-none focus:border-primary focus-visible:shadow-none dark:border-gray-800 dark:bg-gray-900 dark:text-white @error('kategori_kendaraan') border-error @enderror">
                ...
                <div>
                    ...
                    <select name="jenis_kendaraan" required class="w-full rounded-lg border border-gray-200 bg-white py-2 px-4 text-gray-700 outline-none focus:border-primary focus-visible:shadow-none dark:border-gray-800 dark:bg-gray-900 dark:text-gray-200 @error('jenis_kendaraan') border-error @enderror">
                ...
                <div>
                    ...
                    <select name="status" required class="w-full rounded-lg border border-gray-200 bg-white py-2 px-4 text-gray-700 outline-none focus:border-primary focus-visible:shadow-none dark:border-gray-800 dark:bg-gray-900 dark:text-gray-200 @error('status') border-error @enderror">
                        <option value="Tersedia" class="text-gray-700 dark:text-white" {{ old('status', $kendaraan->status) == 'Tersedia' ? 'selected' : '' }}>Tersedia</option>
                        <option value="Dipakai" class="text-gray-700 dark:text-white" {{ old('status', $kendaraan->status) == 'Dipakai' ? 'selected' : '' }}>Dipakai</option>
                        <option value="Perbaikan" class="text-gray-700 dark:text-white" {{ old('status', $kendaraan->status) == 'Perbaikan' ? 'selected' : '' }}>Perbaikan</option>
                    </select>
