                ...
                <tr class="hover:bg-gray-50/50 dark:hover:bg-white/[0.02] transition-colors">
                    ...
                    <td class="px-5 py-4 pr-6 text-center">
                        <div class="flex items-center justify-center gap-3">
                            <a href="{{ route('kendaraan.show', $kendaraan->id_kend) }}" class="flex h-8 w-8 items-center justify-center rounded-lg bg-gray-100 text-gray-500 hover:bg-success-500 hover:text-white transition-all dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-success-500 dark:hover:text-white" title="Detail">
