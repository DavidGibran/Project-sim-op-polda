...
<div class="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
    ...
    <nav>
        <ol class="flex items-center gap-2 text-sm">
            ...
            <li class="font-medium text-primary dark:text-">Edit</li>
        </ol>
    </nav>
</div>
...
<div class="rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-gray-800 dark:bg-white/[0.03]">
    <form action="{{ route('kendaraan.update', $kendaraan->id_kend) }}" method="POST">
        ...
        <div class="p-6">
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="status" required class="w-full rounded-lg border border-gray-200 bg-white py-2 px-4 text-gray-700 outline-none focus:border-primary focus-visible:shadow-none dark:border-gray-200 dark:bg-gray-900 dark:text-gray-200 @error('status') border-error @enderror">
        ...
        <div class="border-t border-gray-100 dark:border-gray-800 px-6 py-5 flex items-center justify-end gap-3 bg-gray-50 dark:bg-white/5 rounded-b-2xl">
            ...
            <button type="submit" class="inline-flex items-center justify-center rounded-lg bg-primary px-5 py-2.5 text-center text-sm font-medium text-succes-500 hover:bg-primary/90 dark:bg-primary dark:text-white transition-all">
                Perbarui Kendaraan
            </button>
        </div>
    </form>
