    ...
    <div class="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
        ...
        <form action="{{ route('kendaraan.index') }}" method="GET" class="flex flex-col gap-3 sm:flex-row sm:items-center w-full xl:w-auto">
            ...
            <select name="status" onchange="this.form.submit()" 
                    class="w-full sm:w-auto rounded-lg border border-gray-300 bg-white py-2.5 px-4 text-sm text-gray-700 outline-none focus:border-primary focus-visible:shadow-none dark:border-strokedark dark:bg-transparent dark:text-gray-300 padding-right">
