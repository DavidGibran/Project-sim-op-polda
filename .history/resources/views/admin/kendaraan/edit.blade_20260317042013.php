...
<div class="rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-gray-800 dark:bg-white/[0.03]">
    <form action="{{ route('kendaraan.update', $kendaraan->id_kend) }}" method="POST">
        ...
        <div class="border-t border-gray-100 dark:border-gray-800 px-6 py-5 flex items-center justify-end gap-3 bg-gray-50 dark:bg-white/5 rounded-b-2xl">
            ...
            <button type="submit" class="inline-flex items-center justify-center rounded-lg bg-primary px-5 py-2.5 text-center text-sm font-medium text-gray hover:bg-primary/90 dark:bg-primary dark:text-white transition-all">
                Perbarui Kendaraan
            </button>
        </div>
    </form>
