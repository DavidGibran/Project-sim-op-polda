        ...
        <table class="w-full text-left">
            <thead>
                <tr class="bg-gray-100 dark:bg-white/5">
                    ...
                    <th class="border-b border-gray-100 px-5 py-4 pr-6 text-xs font-semibold uppercase tracking-wider text-gray-600 dark:border-gray-800 dark:text-gray-300 text-align">Aksi</th>
                </tr>
            </thead>
