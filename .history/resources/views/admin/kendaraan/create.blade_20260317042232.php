            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="kategori_kendaraan" required class="w-full rounded-lg border border-gray-200 bg-white py-2 px-4 text-gray-700 outline-none focus:border-primary focus-visible:shadow-none dark:border-strokedark dark:bg-gray-900 dark:text-gray-200 @error('kategori_kendaraan') border-error @enderror">
                        ...
                        <option value="R2" class="text-gray-700" {{ old('kategori_kendaraan') == 'R2' ? 'selected' : '' }}>Roda 2 (R2)</option>
                        <option value="R4" class="text-gray-700" {{ old('kategori_kendaraan') == 'R4' ? 'selected' : '' }}>Roda 4 (R4)</option>
                        <option value="R6" class="text-gray-700" {{ old('kategori_kendaraan') == 'R6' ? 'selected' : '' }}>Roda 6 (R6)</option>
                        <option value="Lainnya" class="text-gray-700" {{ old('kategori_kendaraan') == 'Lainnya' ? 'selected' : '' }}>Lainnya</option>
                    </select>
                ...
                <div>
                    ...
                    <select name="jenis_kendaraan" required class="w-full rounded-lg border border-gray-200 bg-white py-2 px-4 text-gray-700 outline-none focus:border-primary focus-visible:shadow-none dark:border-strokedark dark:bg-boxdark dark:text-gray-200 @error('jenis_kendaraan') border-error @enderror">
                        ...
                        <option value="RANUM" class="text-gray-700" {{ old('jenis_kendaraan') == 'RANUM' ? 'selected' : '' }}>RANUM</option>
                        <option value="RANSUS" class="text-gray-700" {{ old('jenis_kendaraan') == 'RANSUS' ? 'selected' : '' }}>RANSUS</option>
                        <option value="OPERASIONAL" class="text-gray-700" {{ old('jenis_kendaraan') == 'OPERASIONAL' ? 'selected' : '' }}>OPERASIONAL</option>
                        <option value="LAINNYA" class="text-gray-700" {{ old('jenis_kendaraan') == 'LAINNYA' ? 'selected' : '' }}>LAINNYA</option>
                    </select>
                ...
                <div>
                    ...
                    <select name="status" required class="w-full rounded-lg border border-gray-200 bg-white py-2 px-4 text-gray-700 outline-none focus:border-primary focus-visible:shadow-none dark:border-strokedark dark:bg-boxdark dark:text-gray-200 @error('status') border-error @enderror">
                        <option value="Tersedia" class="text-gray-700" {{ old('status', 'Tersedia') == 'Tersedia' ? 'selected' : '' }}>Tersedia</option>
                        <option value="Dipakai" class="text-gray-700" {{ old('status') == 'Dipakai' ? 'selected' : '' }}>Dipakai</option>
                        <option value="Perbaikan" class="text-gray-700" {{ old('status') == 'Perbaikan' ? 'selected' : '' }}>Perbaikan</option>
                    </select>
