        ...
        <div class="p-6">
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="kategori_kendaraan" required class="w-full rounded-lg border border-gray-200 bg-white py-2 px-4 text-gray-700 outline-none focus:border-primary focus-visible:shadow-none dark:border-gray-100 dark:bg-gray-900 dark:text-gray-200 @error('kategori_kendaraan') border-error @enderror">
