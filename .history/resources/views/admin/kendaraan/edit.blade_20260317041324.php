...
<div class="rounded-2xl border border-gray-200 bg-white shadow-sm dark:border-gray-800 dark:bg-white/[0.03]">
    <form action="{{ route('kendaraan.update', $kendaraan->id_kend) }}" method="POST">
        @csrf
        @method('PUT')
        <div class="p-6">
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" name="merk" value="{{ old('merk', $kendaraan->merk) }}" required placeholder="Misal: Honda" class="w-full rounded-lg border border-gray-200 bg-transparent py-2 px-4 outline-none focus:border-primary focus-visible:shadow-none dark:border-gray-800 dark:bg-gray-900/50 dark:text-white @error('merk') border-error @enderror">
                ...
                <div>
                    ...
                    <select name="kategori_kendaraan" required class="w-full rounded-lg border border-gray-200 bg-white py-2 px-4 text-gray-700 outline-none focus:border-primary focus-visible:shadow-none dark:border-strokedark dark:bg-gray-900 dark:text-white @error('kategori_kendaraan') border-error @enderror">
                        <option value="" class="text-gray-700 dark:text-white">Pilih Kategori</option>
                        <option value="R2" class="text-gray-700 dark:text-white" {{ old('kategori_kendaraan', $kendaraan->kategori_kendaraan) == 'R2' ? 'selected' : '' }}>Roda 2 (R2)</option>
                        <option value="R4" class="text-gray-700 dark:text-white" {{ old('kategori_kendaraan', $kendaraan->kategori_kendaraan) == 'R4' ? 'selected' : '' }}>Roda 4 (R4)</option>
                        <option value="R6" class="text-gray-700 dark:text-white" {{ old('kategori_kendaraan', $kendaraan->kategori_kendaraan) == 'R6' ? 'selected' : '' }}>Roda 6 (R6)</option>
                        <option value="Lainnya" class="text-gray-700 dark:text-white" {{ old('kategori_kendaraan', $kendaraan->kategori_kendaraan) == 'Lainnya' ? 'selected' : '' }}>Lainnya</option>
                    </select>
                ...
                <div>
                    ...
                    <select name="jenis_kendaraan" required class="w-full rounded-lg border border-gray-200 bg-white py-2 px-4 text-gray-700 outline-none focus:border-primary focus-visible:shadow-none dark:border-strokedark dark:bg-boxdark dark:text-gray-200 @error('jenis_kendaraan') border-error @enderror">
                        <option value="" class="text-gray-700">Pilih Jenis</option>
                        <option value="RANUM" class="text-gray-700" {{ old('jenis_kendaraan', $kendaraan->jenis_kendaraan) == 'RANUM' ? 'selected' : '' }}>RANUM</option>
                        <option value="RANSUS" class="text-gray-700" {{ old('jenis_kendaraan', $kendaraan->jenis_kendaraan) == 'RANSUS' ? 'selected' : '' }}>RANSUS</option>
                        <option value="OPERASIONAL" class="text-gray-700" {{ old('jenis_kendaraan', $kendaraan->jenis_kendaraan) == 'OPERASIONAL' ? 'selected' : '' }}>OPERASIONAL</option>
                        <option value="LAINNYA" class="text-gray-700" {{ old('jenis_kendaraan', $kendaraan->jenis_kendaraan) == 'LAINNYA' ? 'selected' : '' }}>LAINNYA</option>
                    </select>
                ...
                <div>
                    ...
                    <input type="number" name="km_terakhir" value="{{ old('km_terakhir', $kendaraan->km_terakhir) }}" required min="0" placeholder="Misal: 12000" class="w-full rounded-lg border border-gray-200 bg-transparent py-2 px-4 outline-none focus:border-primary focus-visible:shadow-none dark:border-gray-800 dark:bg-gray-900/50 dark:text-white @error('km_terakhir') border-error @enderror">
                ...
                <div>
                    ...
                    <select name="status" required class="w-full rounded-lg border border-gray-200 bg-white py-2 px-4 text-gray-700 outline-none focus:border-primary focus-visible:shadow-none dark:border-strokedark dark:bg-boxdark dark:text-gray-200 @error('status') border-error @enderror">
                        <option value="Tersedia" class="text-gray-700" {{ old('status', $kendaraan->status) == 'Tersedia' ? 'selected' : '' }}>Tersedia</option>
                        <option value="Dipakai" class="text-gray-700" {{ old('status', $kendaraan->status) == 'Dipakai' ? 'selected' : '' }}>Dipakai</option>
                        <option value="Perbaikan" class="text-gray-700" {{ old('status', $kendaraan->status) == 'Perbaikan' ? 'selected' : '' }}>Perbaikan</option>
                    </select>
            ...
            <div class="mt-6">
                ...
                <textarea name="keterangan_penggunaan" rows="3" class="w-full rounded-lg border border-gray-200 bg-transparent py-2 px-4 outline-none focus:border-primary focus-visible:shadow-none dark:border-gray-800 dark:bg-gray-900/50 dark:text-white @error('keterangan_penggunaan') border-error @enderror" placeholder="Deskripsi pemakaian atau keadaan (opsional)">{{ old('keterangan_penggunaan', $kendaraan->keterangan_penggunaan) }}</textarea>
        ...
        <div class="border-t border-gray-100 dark:border-gray-800 px-6 py-5 flex items-center justify-end gap-3 bg-gray-50 dark:bg-white/5 rounded-b-2xl">
            ...
            <button type="submit" class="inline-flex items-center justify-center rounded-lg bg-primary px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-primary/90 dark:bg-primary dark:text-white transition-all">
                Perbarui Kendaraan
            </button>
        </div>
    </form>
