...
<!-- Alert Success -->
@if(session('success'))
<div class="mb-6 flex w-full border-l-6 border-success-200 bg-success/10 px-7 py-4 shadow-md dark:bg-success/20 dark:border-success-500 rounded-lg">
    <div class="mr-5 flex h-9 w-full max-w-9 items-center justify-center rounded-lg bg-success/20">
        <svg class="text-success dark:text-success-500" width="26" height="26" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div class="w-full">
        <h5 class="mb-1 text-lg font-bold text-success dark:text-success-500">Berhasil</h5>
