        ...
        <div class="p-6">
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select name="status" required class="w-full rounded-lg border border-gray-200 bg-white py-2 px-4 text-gray-700 outline-none focus:border-primary focus-visible:shadow-none dark:border-strokedark dark:bg-gray- dark:text-gray-200 @error('status') border-error @enderror">
