...
7:             <div class="bg-brand-950 relative hidden h-full w-full items-center lg:grid lg:w-1/2 dark:bg-white/5">
7:                 <div class="z-1 flex items-center justify-center">
:                     <!-- ===== Common Grid Shape Start ===== -->
9:                     <x-common.common-grid-shape/>
0:                     <div class="flex max-w-xs flex-col items-center">
1:                         <a href="{{ route('dashboard') }}" class="mb-4 block">
2:                             <img src="{{ asset('images/logo/auth-logo.svg') }}" alt="Logo" />
83:                         </a>
