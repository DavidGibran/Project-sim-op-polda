                    ...
                    <div>
                        <div class="mb-5 sm:mb-8">
                            ...
                            <p class="text-sm text-gray-500 dark:text-gray-400">
                                Bidang Teknologi Informasi dan Komunikasi Polda Jawa Timur Masukkan kredensial Anda untuk masuk ke dalam sistem.
                            </p>
                        </div>
                        <div>
                 ...
                 <div class="z-1 flex items-center justify-center">
                     ...
                     <div class="flex max-w-xs flex-col items-center">
                         <a href="{{ route('dashboard') }}" class="mb-4 block">
                             <img src="{{ asset('images/logo/logo-tik-polri.png') }}" width="125px" alt="Logo" />
                         </a>
                         <p class="text-center text-gray-400 dark:text-white/60">
                             Sistem Manajemen Operasional Kendaraan
                         </p>
                     </div>
                 </div>
             </div>
